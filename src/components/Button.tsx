...
export default function Button() {
  return (
    <a
      ...
      className="group relative flex w-fit items-center justify-center overflow-hidden rounded-md border-2 border-slate-600 bg-[#1f1f1f] px-4 py-2 font-bold text-white transition-transform ease-out hover:scale-105"
    >
